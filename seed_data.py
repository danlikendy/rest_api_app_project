...
def seed_data():
    ...
    try:
        # Создаем здания
        buildings_data = [
            {"address": "г. Москва, ул. Ленина, д. 1, офис 3", "latitude": 55.7558, "longitude": 37.6176},
            {"address": "г. Москва, ул. Тверская, д. 15", "latitude": 55.7616, "longitude": 37.6094},
            {"address": "г. Москва, ул. Арбат, д. 25", "latitude": 55.7522, "longitude": 37.5914},
            {"address": "г. Москва, ул. Блюхера, д. 32/1", "latitude": 55.7890, "longitude": 37.6123},
            {"address": "г. Москва, ул. Красная Площадь, д. 1", "latitude": 55.7539, "longitude": 37.6208},
        ]
        ...
        # Уровень 2
        level2_activities = [
            {"name": "Мясная продукция", "parent_id": activities[0].id, "level": 2},  # Еда
            {"name": "Молочная продукция", "parent_id": activities[0].id, "level": 2},  # Еда
            {"name": "Овощи и фрукты", "parent_id": activities[0].id, "level": 2},  # Еда
            {"name": "Грузовые", "parent_id": activities[1].id, "level": 2},  # Автомобили
            {"name": "Легковые", "parent_id": activities[1].id, "level": 2},  # Автомобили
            {"name": "Мужская одежда", "parent_id": activities[2].id, "level": 2},  # Одежда
            {"name": "Женская одежда", "parent_id": activities[2].id, "level": 2},  # Одежда
            {"name": "Ремонт", "parent_id": activities[3].id, "level": 2},  # Услуги
            {"name": "Консультации", "parent_id": activities[3].id, "level": 2},  # Услуги
        ]
        ...
        # Уровень 3
        level3_activities = [
            {"name": "Запчасти", "parent_id": level2_activities_objects[4].id, "level": 3},  # Легковые
            {"name": "Аксессуары", "parent_id": level2_activities_objects[4].id, "level": 3},  # Легковые
            {"name": "Рубашки", "parent_id": level2_activities_objects[5].id, "level": 3},  # Мужская одежда
            {"name": "Брюки", "parent_id": level2_activities_objects[5].id, "level": 3},  # Мужская одежда
            {"name": "Платья", "parent_id": level2_activities_objects[6].id, "level": 3},  # Женская одежда
            {"name": "Юбки", "parent_id": level2_activities_objects[6].id, "level": 3},  # Женская одежда
        ]
